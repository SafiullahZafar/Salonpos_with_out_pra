...
<head>
    ...
    <title>Two-Factor Verification — Veloura Salon</title>
    ...
    <style>
        ...
        *{margin:0;padding:0;box-sizing:border-box;font-family:'Inter',sans-serif;}
        ...
        .auth-brand-icon{width:64px;height:64px;border-radius:18px;background:linear-gradient(135deg,var(--y1),var(--yd));display:flex;align-items:center;justify-content:center;margin:0 auto 20px;box-shadow:0 10px 24px rgba(76,29,149,.3);}
        ...
        .form-header-icon{width:52px;height:52px;border-radius:14px;background:linear-gradient(135deg,var(--y1),var(--yd));display:flex;align-items:center;justify-content:center;margin:0 auto 14px;box-shadow:0 6px 16px rgba(76,29,149,.25);}
        ...
        /* QR Section */
        .qr-card{background:var(--ybg);border:1.5px solid #DDD6FE;border-radius:14px;padding:18px;margin-bottom:18px;width:100%;text-align:center;}
        ...
        .qr-secret{font-family:monospace;font-size:.8rem;color:var(--yk);background:#fff;border:1.5px dashed #DDD6FE;border-radius:7px;padding:6px 10px;display:inline-block;letter-spacing:.04em;word-break:break-all;}
        ...
        .code-input:focus{border-color:var(--yd);box-shadow:0 0 0 3px rgba(76,29,149,.12);}
        ...
        .btn-verify{
            ...
            box-shadow:0 4px 14px rgba(76,29,149,.3);transition:.2s;
        }
        .btn-verify:hover{transform:translateY(-1px);box-shadow:0 6px 20px rgba(76,29,149,.4);}

        .error-box{background:#F5F3FF;border:1.5px solid #DDD6FE;border-radius:10px;padding:10px 13px;margin-bottom:16px;color:#4C1D95;font-size:.82rem;font-weight:600;display:flex;align-items:center;gap:8px;width:100%;}

        .cancel-wrap{margin-top:14px;text-align:center;}
        .cancel-wrap button{background:none;border:none;color:#94a3b8;cursor:pointer;font-weight:600;font-size:.8rem;font-family:'Inter',sans-serif;transition:.15s;}
...
.auth-right{width:auto;flex:1}.auth-right-inner{max-width:520px}.form-title{color:#4C1D95}.btn-verify{background:#6D28D9;color:#fff;box-shadow:0 6px 18px rgba(109,40,217,.22)}
</style>
</head>
<body>
    <div class="auth-left">
