...
<head>
    ...
    <title>Forgot Password — Veloura Salon</title>
    ...
    <style>
        ...
        *{margin:0;padding:0;box-sizing:border-box;font-family:'Inter',sans-serif;}
        ...
        .btn-send{width:100%;padding:13px;background:linear-gradient(135deg,var(--y1),var(--yd));border:none;border-radius:11px;color:#18181b;font-size:.95rem;font-weight:700;cursor:pointer;font-family:'Inter',sans-serif;box-shadow:0 4px 14px rgba(76,29,149,.3);transition:.2s;}
        .btn-send:hover{transform:translateY(-1px);box-shadow:0 6px 20px rgba(76,29,149,.4);}

        .status-box{background:var(--ybg);border:1.5px solid #DDD6FE;border-radius:10px;padding:12px 14px;margin-bottom:20px;color:var(--yk);font-size:.83rem;font-weight:600;display:flex;align-items:center;gap:8px;width:100%;}
...
.auth-right{width:auto;flex:1}.form-title{color:#4C1D95}.btn-send{background:#6D28D9;color:#fff;box-shadow:0 6px 18px rgba(109,40,217,.22)}
</style>
</head>
<body>
    <div class="auth-left">
