...
.btn-solid:hover{transform:translateY(-1px);box-shadow:0 5px 16px rgba(124,58,237,.35);}
...
.code-chip{display:inline-block;background:#F5F3FF;border:1px solid #DDD6FE;color:#4C1D95;font-family:monospace;font-size:.82rem;font-weight:700;padding:4px 12px;border-radius:8px;letter-spacing:.06em;}
