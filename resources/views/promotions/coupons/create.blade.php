        ...
        <form action="{{ route('promotions.coupons.store') }}" method="POST">
            ...
            <div class="form-section">
                ...
                <div class="f-grid-2" style="margin-bottom:14px;">
                    <div>
                        <label class="f-label">Coupon Code <span style="color:#6D28D9;">*</span></label>
                    ...
                    <div>
                        <label class="f-label">Coupon Name <span style="color:#6D28D9;">*</span></label>
                ...
                <div>
                    ...
                    <textarea name="description" class="f-input" placeholder="Describe this couponâ€¦">{{ old('description') }}</textarea>
            ...
            <div class="form-section">
                ...
                <label class="check-row">
                    ...
                    <span class="check-label">Active â€” coupon can be used immediately</span>
                </label>
            </div>
