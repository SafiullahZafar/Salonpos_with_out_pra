...
.f-input:focus{border-color:#7C3AED;background:#fff;box-shadow:0 0 0 3px rgba(124,58,237,.1);}
...
.error-msg{font-size:.75rem;color:#4C1D95;margin-top:4px;}
...
.bxgy-panel{background:#F5F3FF;border:1px solid #DDD6FE;border-radius:12px;padding:14px 16px;}
.bxgy-title{font-size:.72rem;font-weight:700;color:#6D28D9;text-transform:uppercase;letter-spacing:.07em;margin-bottom:12px;}
...
.btn-save{padding:10px 22px;border:none;background:linear-gradient(135deg,#7C3AED,#6D28D9);border-radius:10px;color:#fff;font-size:.875rem;font-weight:700;cursor:pointer;font-family:'Inter',sans-serif;transition:.2s;box-shadow:0 3px 10px rgba(124,58,237,.25);}
        ...
        <form action="{{ route('promotions.discount-rules.store') }}" method="POST">
            ...
            <div class="form-section">
                ...
                <div class="f-grid-2" style="margin-bottom:14px;">
                    <div>
                        <label class="f-label">Rule Name <span style="color:#6D28D9;">*</span></label>
                        <input type="text" name="name" value="{{ old('name') }}" required class="f-input" placeholder="e.g. Weekend 10% Off">
                        @error('name')<div class="error-msg">{{ $message }}</div>@enderror
                    </div>
                    <div>
                        <label class="f-label">Discount Type <span style="color:#6D28D9;">*</span></label>
                ...
                <div>
                    ...
                    <textarea name="description" class="f-input" placeholder="Describe when this rule appliesâ€¦">{{ old('description') }}</textarea>
            ...
            <div class="form-section">
                ...
                <div id="value-field" style="display:none;">
                    <label class="f-label">Discount Value <span style="color:#6D28D9;">*</span></label>
                ...
                <div id="buy-quantity-field" style="display:none;">
                    <div class="bxgy-panel">
                        ...
                        <div class="f-grid-2">
                            <div>
                                <label class="f-label">Buy Quantity <span style="color:#6D28D9;">*</span></label>
                            ...
                            <div>
                                <label class="f-label">Get Quantity <span style="color:#6D28D9;">*</span></label>
            ...
            <div class="form-section">
                ...
                <label class="check-row">
                    ...
                    <span class="check-label">Active â€” rule applies at checkout immediately</span>
                </label>
            </div>
