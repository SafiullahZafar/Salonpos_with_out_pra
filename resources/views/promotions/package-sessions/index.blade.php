...
.prog-fill{height:100%;border-radius:99px;background:linear-gradient(90deg,#7C3AED,#6D28D9);}
...
<div class="table-wrap">
  ...
  <table class="promo-table">
    ...
    <tr>
      ...
      <td><div class="prog-track"><div class="prog-fill" style="width:{{ $pct }}%"></div></div><div style="font-size:.7rem;color:#6D28D9;font-weight:600;">{{ $pct }}%</div></td>
