...
.page-header .po-number{color:#6D28D9;font-weight:600;}
.btn-back,.btn-submit{padding:8px 16px;background:#f1f5f9;color:#475569;border:1px solid #e2e8f0;border-radius:10px;text-decoration:none;font-weight:600;cursor:pointer;font-family:'Inter',sans-serif;display:inline-block;}
.btn-submit{background:#7C3AED;color:#fff;border-color:#7C3AED;}
...
.form-input,.form-select,.form-textarea{padding:10px 12px;border:1px solid #d1d5db;border-radius:8px;font-size:.9rem;font-family:'Inter',sans-serif;width:100%;box-sizing:border-box;}
.form-input:focus,.form-select:focus,.form-textarea:focus{outline:none;border-color:#7C3AED;box-shadow:0 0 0 3px rgba(59,130,246,.1);}
...
.btn-add-item{padding:6px 12px;background:#7C3AED;color:#fff;border:none;border-radius:6px;font-weight:600;cursor:pointer;font-family:'Inter',sans-serif;}

.item-row{display:grid;grid-template-columns:3fr 1fr 1fr 1fr auto;gap:12px;margin-bottom:12px;align-items:end;}
.item-input,.item-select{padding:8px 10px;border:1px solid #d1d5db;border-radius:6px;font-size:.85rem;font-family:'Inter',sans-serif;}
.btn-remove-item{padding:8px 12px;background:#6D28D9;color:#fff;border:none;border-radius:6px;font-weight:600;cursor:pointer;font-family:'Inter',sans-serif;}

.total-section{background:#fff;border:1px solid #e2e8f0;border-radius:12px;padding:16px;margin-top:20px;text-align:right;}
.total-amount{font-size:1.25rem;font-weight:700;color:#6D28D9;}

.status-notice{background:#EDE9FE;border:1px solid #8B5CF6;border-radius:8px;padding:12px;margin-bottom:16px;}
.status-notice p{margin:0;font-size:.85rem;color:#4C1D95;}
</style>
