...
.btn-add{padding:8px 16px;background:#7C3AED;color:#fff;border:none;border-radius:10px;text-decoration:none;font-weight:600;cursor:pointer;font-family:'Inter',sans-serif;display:inline-block;}

.filters{display:flex;gap:12px;margin-bottom:20px;flex-wrap:wrap;}
.filter-group{display:flex;flex-direction:column;gap:4px;}
.filter-label{font-size:.8rem;font-weight:600;color:#64748b;text-transform:uppercase;}
.filter-select,.filter-input{padding:8px 12px;border:1px solid #e2e8f0;border-radius:8px;font-size:.9rem;font-family:'Inter',sans-serif;}
...
.amount{font-weight:600;color:#6D28D9;}

.action-btns{display:flex;gap:6px;}
.btn-view,.btn-edit,.btn-receive{padding:5px 10px;background:#f1f5f9;color:#475569;border:1px solid #e2e8f0;border-radius:6px;text-decoration:none;font-weight:600;font-size:.75rem;font-family:'Inter',sans-serif;}
.btn-view:hover,.btn-edit:hover,.btn-receive:hover{background:#e2e8f0;}
.btn-receive{background:#7C3AED;color:#fff;border-color:#7C3AED;}
.btn-receive:hover{background:#6D28D9;}
