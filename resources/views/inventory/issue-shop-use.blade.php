...
.form-card{background:#fff;border:1.5px solid #DDD6FE;border-radius:16px;padding:24px;box-shadow:0 1px 6px rgba(0,0,0,.04);max-width:600px;}
.f-label{display:block;font-size:.75rem;font-weight:600;color:#374151;margin-bottom:6px;}
.f-input,.f-select{width:100%;padding:9px 12px;border:1.5px solid #DDD6FE;border-radius:9px;font-size:.875rem;color:#18181b;background:var(--ybg);margin-bottom:16px;}
