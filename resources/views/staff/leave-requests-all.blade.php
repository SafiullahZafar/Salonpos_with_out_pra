...
.filter-btn{padding:6px 12px;background:#f1f5f9;color:#475569;border:1px solid #e2e8f0;border-radius:8px;cursor:pointer;font-weight:600;font-size:.85rem;font-family:'Inter',sans-serif;transition:all .2s;}
...
.btn-approve, .btn-reject{padding:5px 10px;border:none;border-radius:6px;cursor:pointer;font-weight:600;font-size:.75rem;font-family:'Inter',sans-serif;}
.btn-approve{background:#7C3AED;color:#fff;}
.btn-reject{background:#6D28D9;color:#fff;}
