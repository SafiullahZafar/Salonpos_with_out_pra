...
/* Supplier workspace visual system */
:root{--y1:#6D28D9;--y2:#EDE9FE;--yd:#6D28D9;--ydark:#4C1D95;--ybg:#F5F3FF}.ui-page-header{position:relative;align-items:center;padding:25px 28px;margin-bottom:16px;color:#fff;background:linear-gradient(125deg,#3B0764,#6D28D9);border-radius:17px;box-shadow:0 10px 28px rgba(59,7,100,.16);overflow:hidden}.ui-page-header::after{content:'';position:absolute;right:-55px;top:-85px;width:230px;height:230px;border:1px solid rgba(255,255,255,.16);border-radius:50%}.ui-page-header>div,.ui-page-header__actions{position:relative;z-index:1}.ui-page-header__eyebrow,.ui-page-header__title,.ui-page-header__description{color:#fff!important}.ui-page-header__eyebrow{color:#DDD6FE!important}.ui-page-header__description{color:#E9D5FF!important}.btn-add{min-height:43px;padding:0 17px!important;color:#3B0764!important;background:#fff!important;border-radius:10px!important;box-shadow:none!important}.supplier-toolbar{justify-content:space-between!important;padding:13px 15px!important;margin:0 0 17px!important;border:1px solid #E7E1EC!important;border-radius:12px!important}.supplier-toolbar::before{content:'SUPPLIER DIRECTORY';color:#8A8291;font-size:.62rem;font-weight:850;letter-spacing:.1em}.search-input{height:40px;background:#fff!important;border-color:#E7E1EC!important;font-family:'Inter',sans-serif}.btn-search{height:40px;margin-left:2px!important;color:#4C1D95!important;background:#F5F3FF!important;border:1px solid #DDD6FE!important;box-shadow:none!important}.supp-grid{grid-template-columns:repeat(auto-fill,minmax(300px,1fr));gap:16px}.supp-card{min-height:285px;padding:21px;border:1px solid #E7E1EC;border-radius:16px;box-shadow:0 5px 18px rgba(59,7,100,.05);overflow:hidden}.supp-card::before{content:'';position:absolute;left:0;right:0;top:0;height:4px;background:linear-gradient(90deg,#3B0764,#A78BFA)}.supp-card:hover{transform:translateY(-3px);border-color:#C4B5FD;box-shadow:0 12px 30px rgba(59,7,100,.1)}.supp-icon-wrap{width:50px;height:50px;margin:3px 0 15px;color:#4C1D95;background:#F5F3FF;border:1px solid #DDD6FE;border-radius:13px;box-shadow:none}.supp-name{color:#2B2032}.supp-info-list{border-color:#EEEAF1}.supp-actions{border-color:#EEEAF1}.btn-act{background:#fff!important;border:1px solid #E7E1EC!important;border-radius:8px;font-family:'Inter',sans-serif}.btn-edit{color:#4C1D95!important;border-color:#C4B5FD!important}.btn-del{color:#6D28D9!important;border-color:#DDD6FE!important}@media(max-width:650px){.ui-page-header{align-items:stretch;flex-direction:column}.btn-add{width:100%;justify-content:center}.supplier-toolbar{align-items:stretch!important;flex-direction:column}.supplier-toolbar::before{margin-bottom:5px}.supplier-toolbar form{width:100%}.search-wrap,.search-input,.btn-search{width:100%}}
/* Apply the masthead to this legacy page's existing header markup. */
.pg-header{position:relative;align-items:center;padding:25px 28px;margin-bottom:16px;color:#fff;background:linear-gradient(125deg,#3B0764,#6D28D9);border-radius:17px;box-shadow:0 10px 28px rgba(59,7,100,.16);overflow:hidden}.pg-header::after{content:'';position:absolute;right:-55px;top:-85px;width:230px;height:230px;border:1px solid rgba(255,255,255,.16);border-radius:50%}.pg-header>div{position:relative;z-index:1}.pg-title{color:#fff;font-size:1.65rem}.pg-sub{color:#E9D5FF}.header-right{align-items:center}.header-right form{padding:4px;background:#fff;border-radius:11px}.btn-add{min-height:48px!important}@media(max-width:650px){.pg-header{align-items:stretch;flex-direction:column}.header-right{align-items:stretch;flex-direction:column}.header-right form{width:100%}.btn-add{width:100%;justify-content:center}}
</style>
