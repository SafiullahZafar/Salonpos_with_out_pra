...
/* Supplier business dossier */
.page-header{position:relative;align-items:center;padding:27px 29px;margin-bottom:14px;color:#fff;background:linear-gradient(125deg,#3B0764,#6D28D9);border:0;border-radius:17px;box-shadow:0 10px 30px rgba(59,7,100,.17);overflow:hidden}.page-header::after{content:'';position:absolute;right:-55px;top:-75px;width:220px;height:220px;border:1px solid rgba(255,255,255,.16);border-radius:50%}.page-header>div,.page-header>form{position:relative;z-index:1}.page-header h2{color:#DDD6FE;font-size:.7rem;font-weight:850;letter-spacing:.12em;text-transform:uppercase}.page-header .supplier-name{margin-top:6px;color:#fff;font-size:1.8rem;font-weight:850;letter-spacing:-.045em}.btn-back,.btn-edit,.btn-delete{color:#fff;background:rgba(255,255,255,.1);border-color:rgba(255,255,255,.3);border-radius:9px;font-size:.72rem;font-weight:800}.btn-edit{color:#3B0764;background:#fff;border-color:#fff}.btn-delete{color:#fff;background:transparent}.status-badge{padding:6px 12px;margin:0 0 15px;color:#4C1D95;background:#F5F3FF;border:1px solid #DDD6FE}.details-grid{gap:14px;margin-bottom:15px}.detail-card{padding:22px;border-color:#E7E1EC;border-radius:14px;box-shadow:0 5px 20px rgba(59,7,100,.045)}.detail-card h3{padding-bottom:11px;color:#3B0764;border-bottom:1px solid #EEEAF1}.detail-row{padding:8px 0;margin:0;border-bottom:1px solid #F1EDF3}.detail-row:last-child{border-bottom:0}.stats-section{padding:0;background:#fff;border-color:#E7E1EC;border-radius:14px;overflow:hidden}.stats-section>h3{padding:17px 20px;margin:0!important;color:#3B0764!important;border-bottom:1px solid #E7E1EC}.stats-grid{gap:0}.stat-card{padding:19px;text-align:left;border:0;border-right:1px solid #E7E1EC;border-radius:0}.stat-card:last-child{border-right:0}.stat-value{color:#3B0764;font-size:1.35rem}.stat-label{margin-top:6px;font-size:.64rem;font-weight:800;letter-spacing:.07em}.products-section,.purchases-section{border-color:#E7E1EC;border-radius:14px;box-shadow:0 5px 20px rgba(59,7,100,.04)}.products-head,.purchases-head{height:46px;align-items:center;background:#fff;color:#6C6372;border-color:#DDD6FE;font-size:.65rem;letter-spacing:.075em}.products-row,.purchases-row{min-height:54px;border-color:#EEEAF1}@media(max-width:760px){.page-header{align-items:stretch;flex-direction:column}.page-header>div:last-child{flex-wrap:wrap}.details-grid{grid-template-columns:1fr}.stats-grid{grid-template-columns:1fr 1fr}.stat-card{border-bottom:1px solid #E7E1EC}.products-section,.purchases-section{overflow:auto}.products-head,.products-row{min-width:650px}.purchases-head,.purchases-row{min-width:760px}}
</style>
