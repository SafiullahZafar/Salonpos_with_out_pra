...
/* Refined client profile appearance */
.show-wrap{max-width:1180px}.show-header{padding:17px 20px;margin-bottom:16px;background:#fff;border:1px solid #E7E1EC;border-radius:14px;box-shadow:0 6px 22px rgba(59,7,100,.045)}.back-btn{border-color:#DDD6FE;color:#6D28D9}.btn-edit{color:#4C1D95;background:#fff;border-color:#C4B5FD}.btn-del{color:#6D28D9;background:#fff;border-color:#DDD6FE}.hero-card{border:1px solid #E7E1EC;border-radius:18px;box-shadow:0 10px 34px rgba(59,7,100,.07)}.hero-banner{height:105px;background:linear-gradient(120deg,#3B0764 0%,#6D28D9 58%,#A78BFA 100%)}.hero-banner::after{opacity:.35}.hero-body{padding:24px 28px}.hero-avatar{width:104px;height:104px;border-color:#fff;box-shadow:0 9px 24px rgba(59,7,100,.16)}.hero-name{color:#2B2032;font-size:1.75rem}.social-tag{background:#F5F3FF;border-color:#DDD6FE}.stats-row{gap:10px}.stat-card{min-height:120px;padding:16px;border:1px solid #E7E1EC;border-radius:12px;box-shadow:none}.stat-card:hover{border-color:#C4B5FD;box-shadow:0 7px 20px rgba(59,7,100,.07)}.stat-icon{color:#6D28D9;background:#F5F3FF;border:1px solid #E9E2F0}.stat-val{color:#3B0764}.content-grid{grid-template-columns:minmax(0,1.45fr) minmax(290px,.65fr);gap:18px}.panel{border:1px solid #E7E1EC;border-radius:14px;box-shadow:0 5px 20px rgba(59,7,100,.045)}.panel-head{min-height:53px;padding:13px 17px;background:#fff;border-color:#E7E1EC}.panel-title{color:#302637}.panel-icon{color:#6D28D9;background:#F5F3FF;border:1px solid #E9E2F0}.act-row,.info-row{border-color:#EEEAF1}.act-row{padding:12px 0}.invoice-row:hover{background:#FAF8FC}@media(max-width:850px){.stats-row{grid-template-columns:repeat(2,1fr)}.content-grid{grid-template-columns:1fr}}@media(max-width:560px){.show-header{align-items:stretch;flex-direction:column}.hdr-actions{width:100%;flex-wrap:wrap}.hdr-actions>*{flex:1;justify-content:center}.hero-body{align-items:flex-start;flex-direction:column}.hero-avatar{margin-top:-58px}.stats-row{grid-template-columns:1fr 1fr}.stat-card{min-height:108px}}
</style>
