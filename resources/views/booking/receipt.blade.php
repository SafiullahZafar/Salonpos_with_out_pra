...
<head>
    ...
    <title>Receipt #{{ $invoice->invoice_no }} — Veloura Salon</title>
    ...
    <style>
        ...
        .receipt-card { background:#fff; border:1px solid #EDE9FE; border-radius:20px; box-shadow:0 4px 24px rgba(124,58,237,.10); }
...
<body class="antialiased min-h-screen py-8">
    <div class="max-w-2xl mx-auto px-4">
        ...
        <div class="flex justify-between items-center mb-6 no-print">
            <a href="{{ route('booking.index') }}" class="text-sm font-semibold text-purple-600 hover:text-purple-800 transition-colors">← Back to Booking</a>
        ...
        <div class="receipt-card p-8">
            <div class="text-center mb-8">
                <div class="w-14 h-14 rounded-2xl bg-purple-500 flex items-center justify-center mx-auto mb-3 shadow-md">
                    <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z"/>
                    </svg>
                </div>
                <h1 class="text-3xl font-bold text-purple-700">Veloura Salon</h1>
                <p class="text-slate-500 text-sm mt-1">123 Beauty Lane, Glamour City</p>
                <p class="text-slate-500 text-sm">Tel: +1 234 567 890</p>
            </div>

            <div class="border-t border-b border-purple-100 py-5 mb-6">
            ...
            <div class="mb-6">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex justify-between items-center py-2.5 border-b border-purple-50">
                        <div>
            ...
            <div class="bg-purple-50 rounded-xl p-5 border border-purple-100">
                <div class="space-y-2 text-sm">
                    ...
                    <div class="flex justify-between font-bold text-slate-800 text-lg pt-3 border-t border-purple-200">
                        <span>Total</span><span class="text-purple-600">PKR {{ number_format($invoice->payable_amount, 2) }}</span>
                    </div>
                </div>
            </div>

            <div class="text-center mt-8 pt-6 border-t border-purple-100">
                <p class="text-slate-500 text-sm">Thank you for choosing Veloura Salon!</p>
                <p class="text-slate-400 text-xs mt-1">Generated on {{ now()->format('M d, Y H:i') }}</p>
            </div>
        </div>

        <div class="flex justify-center gap-4 mt-6 no-print">
            <a href="{{ route('booking.index') }}" class="bg-white border border-purple-200 text-purple-700 hover:bg-purple-50 px-6 py-3 rounded-xl font-semibold text-sm transition-colors">Book Another</a>
